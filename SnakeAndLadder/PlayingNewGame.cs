                ...
                switch (option)  //Player checks for options
                {
                    ...
                    case Ladder:
                        ...
                        else if (position > winPosition)
                        {
                            ...
                            Console.WriteLine("The Player Current position is :" + currentPosition);
                    ...
                    default:
                        Console.WriteLine("The default current position is :" + position);
                        break;


                }
                Console.WriteLine("The number of Dice Rolled is :" + Dice);
